...
const foods = [
  // Proteínas
  { name: 'Pechuga de pollo', calories: 165, protein: 31, carbs: 0, fat: 3.6, category: 'protein', unit: '100g' },
  { name: 'Salmón', calories: 208, protein: 20, carbs: 0, fat: 13, category: 'protein', unit: '100g' },
  { name: 'Atún en agua', calories: 132, protein: 28, carbs: 0, fat: 1.3, category: 'protein', unit: '100g' },
  { name: 'Huevos', calories: 155, protein: 13, carbs: 1.1, fat: 11, category: 'protein', unit: '100g' },
  { name: 'Tofu', calories: 76, protein: 8, carbs: 1.9, fat: 4.8, category: 'protein', unit: '100g' },
  
  // Carbohidratos
  { name: 'Arroz integral', calories: 111, protein: 2.6, carbs: 23, fat: 0.9, category: 'carb', unit: '100g' },
  { name: 'Pasta integral', calories: 124, protein: 5, carbs: 25, fat: 1.1, category: 'carb', unit: '100g' },
  { name: 'Avena', calories: 389, protein: 16.9, carbs: 66.3, fat: 6.9, category: 'carb', unit: '100g' },
  { name: 'Quinoa', calories: 120, protein: 4.4, carbs: 22, fat: 1.9, category: 'carb', unit: '100g' },
  { name: 'Pan integral', calories: 247, protein: 13, carbs: 41, fat: 4.2, category: 'carb', unit: '100g' },
  
  // Verduras
  { name: 'Brócoli', calories: 34, protein: 2.8, carbs: 7, fat: 0.4, category: 'vegetable', unit: '100g' },
  { name: 'Espinacas', calories: 23, protein: 2.9, carbs: 3.6, fat: 0.4, category: 'vegetable', unit: '100g' },
  { name: 'Lechuga', calories: 15, protein: 1.4, carbs: 2.9, fat: 0.2, category: 'vegetable', unit: '100g' },
  { name: 'Tomate', calories: 18, protein: 0.9, carbs: 3.9, fat: 0.2, category: 'vegetable', unit: '100g' },
  { name: 'Zanahoria', calories: 41, protein: 0.9, carbs: 10, fat: 0.2, category: 'vegetable', unit: '100g' },
  
  // Frutas
  { name: 'Manzana', calories: 52, protein: 0.3, carbs: 14, fat: 0.2, category: 'fruit', unit: '100g' },
  { name: 'Plátano', calories: 89, protein: 1.1, carbs: 23, fat: 0.3, category: 'fruit', unit: '100g' },
  { name: 'Naranja', calories: 47, protein: 0.9, carbs: 12, fat: 0.1, category: 'fruit', unit: '100g' },
  { name: 'Fresas', calories: 32, protein: 0.7, carbs: 7.7, fat: 0.3, category: 'fruit', unit: '100g' },
  
  // Lácteos
  { name: 'Leche descremada', calories: 34, protein: 3.4, carbs: 5, fat: 0.1, category: 'dairy', unit: '100ml' },
  { name: 'Yogur griego', calories: 59, protein: 10, carbs: 3.6, fat: 0.4, category: 'dairy', unit: '100g' },
  { name: 'Queso cottage', calories: 98, protein: 11, carbs: 3.4, fat: 4.3, category: 'dairy', unit: '100g' },
  
  // Grasas saludables
  { name: 'Aguacate', calories: 160, protein: 2, carbs: 9, fat: 15, category: 'fat', unit: '100g' },
  { name: 'Almendras', calories: 579, protein: 21, carbs: 22, fat: 50, category: 'fat', unit: '100g' },
  { name: 'Aceite de oliva', calories: 884, protein: 0, carbs: 0, fat: 100, category: 'fat', unit: '100ml' },
];
